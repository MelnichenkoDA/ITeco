...
COMPRESS      = gzip -9f
DISTNAME      = Iteco1.0.0
DISTDIR = /home/rusty/Documents/C++/TestExc/ITeco/.tmp/Iteco1.0.0
LINK          = g++
...
distdir: FORCE
	...
	$(COPY_FILE) --parents layoutconstructor.cpp main.cpp mainwidget.cpp mainwindow.cpp makeinputwidget.cpp mymessagebox.cpp sorter.cpp testingwidget.cpp $(DISTDIR)/
...
sorter.o: sorter.cpp sorter.hpp \
		...
		../../../../Qt/5.14.1/gcc_64/include/QtCore/qsharedpointer.h \
		../../../../Qt/5.14.1/gcc_64/include/QtCore/qsharedpointer_impl.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o sorter.o sorter.cpp
